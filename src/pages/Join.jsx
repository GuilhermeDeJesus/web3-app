      ...
      <Container>
        ...
        >
          <SwiperSlide className="py-4 px-3 align-items-start flex-column">
            ...
            <img src={new URL("../images/illustration/01.webp", import.meta.url).href} alt="img" />
            <AnimationTitles
          ...
          <SwiperSlide className="py-4 px-3 align-items-start flex-column">
            ...
            <img src={new URL("../images/illustration/02.webp", import.meta.url).href} alt="img" />
            <AnimationTitles
              title="Asset Owners"
              className="text-white mb-4 mt-5 h4"
            />
          ...
          <SwiperSlide className="py-4 px-3 align-items-start flex-column">
            ...
            <img src={new URL("../images/illustration/03.webp", import.meta.url).href} alt="img" />
            <AnimationTitles
              title="Registration"
              className="text-white mb-4 mt-5 h4"
            />
          ...
          <SwiperSlide className="py-4 px-3 align-items-start flex-column">
            ...
            <img src={new URL("../images/illustration/04.webp", import.meta.url).href} alt="img" />
            <AnimationTitles
