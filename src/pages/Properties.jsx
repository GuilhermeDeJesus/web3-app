                ...
                <Card.Body className="p-2">
                  <div className="rounded overflow-hidden position-relative">
                    <Card.Img
                      variant="top"
                      alt="img"
                      src={new URL("../images/properties/picture-of-a-wooden-building-in-the-forest.webp", import.meta.url).href}
                    />
                ...
                <Card.Body className="p-2">
                  <div className="rounded overflow-hidden position-relative">
                    <Card.Img
                      variant="top"
                      alt="img"
                      src={new URL("../images/properties/pexels-stan-krotov-12737424 1.webp", import.meta.url).href}
                    />
                    <i
                ...
                <Card.Body className="p-2">
                  <div className="rounded overflow-hidden position-relative">
                    <Card.Img
                      variant="top"
                      alt="img"
                      src={new URL("../images/properties/pexels-rachel-claire-8112843 1.webp", import.meta.url).href}
                    />
                    <i className="fa-regular fa-heart like" onClick={like}></i>
                  </div>
                ...
                <Card.Body className="p-2">
                  <div className="rounded overflow-hidden position-relative">
                    <Card.Img
                      variant="top"
                      alt="img"
                      src={new URL("../images/properties/david-kovalenko-9-qFzV9a2Zc-unsplash.webp", import.meta.url).href}
                    />
                    <i className="fa-regular fa-heart like" onClick={like}></i>
                  </div>
                ...
                <Card.Body className="p-2">
                  <div className="rounded overflow-hidden position-relative">
                    <Card.Img
                      variant="top"
                      alt="img"
                      src={new URL("../images/properties/house_big-1.webp", import.meta.url).href}
                    />
                    <i className="fa-regular fa-heart like" onClick={like}></i>
                  </div>
                ...
                <Card.Body className="p-2">
                  <div className="rounded overflow-hidden position-relative">
                    <Card.Img
                      variant="top"
                      alt="img"
                      src={new URL("../images/properties/house_big.webp", import.meta.url).href}
                    />
                    <i className="fa-regular fa-heart like" onClick={like}></i>
                  </div>
